"""Alembic environment for seo-service (seo_db).
...
seo streams coexist on the same physical database (M5 fix).
"""
...
from atoz_seo_service.domain.entities import Base
...
VERSION_TABLE = "alembic_version_seo"
