...
export const MOCK_AUTOMATION_JOBS = [
  {
    id: "job1",
    nicheId: null,
    jobKey: "pin-publish-due",
    cronExpr: "0 6 * * *",
    queue: "pinterest",
    handler: "pinterest.publish_due",
    status: "enabled",
    lastRunAt: "2026-08-13T06:00:00Z",
    nextRunAt: "2026-08-14T06:00:00Z",
  },
  {
    id: "job2",
    nicheId: null,
    jobKey: "sitemap-rebuild",
    cronExpr: "0 2 * * *",
    queue: "seo",
    handler: "seo.sitemap_rebuild",
    status: "enabled",
    lastRunAt: "2026-08-13T02:00:00Z",
    nextRunAt: "2026-08-14T02:00:00Z",
  },
  {
    id: "job3",
    nicheId: null,
    jobKey: "affiliate-reconciliation",
    cronExpr: "0 4 * * 1",
    queue: "affiliate",
    handler: "affiliate.reconciliation",
    status: "enabled",
    lastRunAt: "2026-08-11T04:00:00Z",
    nextRunAt: "2026-08-18T04:00:00Z",
  },
];

export const MOCK_AUTOMATION_RUNS = [
  {
    id: "run1",
    nicheId: null,
    nicheSlug: null,
    scheduledJobId: "job1",
    jobKey: "pin-publish-due",
    runAt: "2026-08-13T06:00:00Z",
    status: "success",
    attempts: 1,
    startedAt: "2026-08-13T06:00:01Z",
    finishedAt: "2026-08-13T06:01:12Z",
    outputRef: "pins:8",
    error: null,
  },
  {
    ...
    scheduledJobId: "job2",
    jobKey: "sitemap-rebuild",
    runAt: "2026-08-13T02:00:00Z",
    status: "success",
    attempts: 1,
    startedAt: "2026-08-13T02:00:01Z",
    finishedAt: "2026-08-13T02:00:42Z",
    outputRef: "shards:3",
    error: null,
  },
  {
    ...
    status: "failed",
    attempts: 2,
    startedAt: "2026-08-11T04:00:01Z",
    finishedAt: "2026-08-11T04:05:03Z",
    outputRef: null,
    error: "affiliate-service: reconciliation rejected (mismatch)",
  },
];

export const MOCK_AUTOMATION_QUEUE = [
  {
    id: "q1",
    nicheId: null,
    nicheSlug: null,
    queue: "pinterest",
    payloadRef: "job_run:run1",
    state: "done",
    attempts: 1,
    maxAttempts: 5,
    runAt: "2026-08-13T06:00:00Z",
    completedAt: "2026-08-13T06:01:12Z",
    error: null,
  },
  {
    id: "q2",
    ...
    nicheSlug: null,
    queue: "seo",
    payloadRef: "job_run:run2",
    state: "done",
    attempts: 1,
    maxAttempts: 5,
    runAt: "2026-08-13T02:00:00Z",
    completedAt: "2026-08-13T02:00:42Z",
    error: null,
  },
  {
    id: "q3",
    ...
    nicheSlug: null,
    queue: "affiliate",
    payloadRef: "job_run:run3",
    state: "failed",
    attempts: 2,
    maxAttempts: 5,
    runAt: "2026-08-11T04:00:00Z",
    completedAt: "2026-08-11T04:05:03Z",
    error: "affiliate-service: reconciliation rejected (mismatch)",
  },
];

export const MOCK_AUTOMATION_EXECUTORS = [
  { id: "aios.dispatch", name: "aios.dispatch", queue: "aios" },
  { id: "affiliate.reconciliation", name: "affiliate.reconciliation", queue: "affiliate" },
  { id: "analytics.rollup", name: "analytics.rollup", queue: "analytics" },
  { id: "pinterest.publish_due", name: "pinterest.publish_due", queue: "pinterest" },
  { id: "seo.sitemap_rebuild", name: "seo.sitemap_rebuild", queue: "seo" },
];
