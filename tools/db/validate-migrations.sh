...
IDEMPOTENCY_INDEXES[affiliate]="uq_affiliate_products_niche_merchant_sku uq_product_categories_niche_slug uq_link_tokens_token uq_affiliate_webhook_source_event uq_revenue_summaries_niche_network_date"
